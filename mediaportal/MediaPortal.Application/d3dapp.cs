...
namespace MediaPortal
{
  ...
  public class D3DApp : MPForm
  {
    ...
    /// <summary>
    /// Called when the Win7 Half Fullscreen Bug occured
    /// This function resizes the MP GUI to fullscreen again without losing timeshift
    /// </summary>
    public void ResizeFullscreen()
    {
      ...
      if (g_Player.Playing && !g_Player.IsMusic)
      {
        ...
        MediaPortal.GUI.Library.Action action = new MediaPortal.GUI.Library.Action(key_F12, MediaPortal.GUI.Library.Action.ActionType.ACTION_PAUSE, 0, 0);
    ...
    protected override void OnResize(EventArgs e)
    {
      ...
      {
        // nothing
        Log.Info("D3D: BackBuffer & DisplayMode not set");
      }
    }
